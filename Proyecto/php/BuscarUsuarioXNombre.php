...
$sqlBuscar = "SELECT Usuario, Contrasena, Nombres, A_Paterno, A_Materno, Tipo FROM usuarios,tipousuario WHERE usuarios.idTUsuario = tipousuario.idTUsuario AND Activo=1 AND Nombres LIKE '$buscarA' '%'";
