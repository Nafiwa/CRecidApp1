...
$sqlBuscar = "SELECT idAsignacion, FechaAsign, usuarios.Usuario, Nombres, A_Paterno, Descripcion, Areas FROM asignacion,turnos,areas,usuarios WHERE asignacion.idTurnos = turnos.idTurnos AND asignacion.idAreas = areas.idAreas AND asignacion.Usuario = usuarios.Usuario AND FechaAsign LIKE '$buscarA' '%'";
